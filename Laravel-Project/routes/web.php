...
// ->middleware('auth','teknisi', 'superadmin');
...
//crud routers
Route::get('/editrouter/{id}', [RoutersController::class, 'edit'])->name('editrouter');
// -> middleware('auth','teknisi', 'superadmin');
Route::put('/updaterouter/{id}', [RoutersController::class, 'update'])->name('updaterouter');
// -> middleware('auth','teknisi', 'superadmin');
Route::get('/deleterouter/{id}', [RoutersController::class, 'destroy'])->name('deleterouter');
// -> middleware('auth','teknisi', 'superadmin');
